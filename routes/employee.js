...
router.post('/', ensureIsAuthenticated, ensureIsAdmin, employeesStore);
router.get('/add', ensureIsAuthenticated, ensureIsAdmin, employeeCreate);
router.post('/delete/:id', ensureIsAuthenticated, ensureIsAdmin, employeeDelete);
router.post('/update/:id', ensureIsAuthenticated, ensureIsAdmin, employeeUpdate);
